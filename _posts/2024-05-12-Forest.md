...
> *A domain controller is a server that responds to security authentication requests within a computer network domain. It is a network server that is responsible for allowing host access to domain resources. It authenticates users, stores user account information and enforces security policy for a domain.* ~Source: [Wikipedia](https://en.wikipedia.org/wiki/Domain_controller)
...
![Elmo](https://tenor.com/view/excited-fuego-gif-26833875)
