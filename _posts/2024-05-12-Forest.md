...
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-05-14 23:07 EAT
...
NSE Timing: About 99.67% done; ETC: 23:10 (0:00:00 remaining)
...
From the output, you can see that this is also another method youd've used for enumerating potential users & groups.

### NetExec

While doing enumeration on targets, I like to combine a couple of tools to get more information, incase I missed some potentially useful information from previous commands. In this case, I moved to my next favourite network service exploitation tool, [NetExec](https://www.netexec.wiki/smb-protocol/enumeration).
...
```bash
➜  Forest impacket-GetNPUsers htb.local/ -request -usersfile users.txt -format hashcat -dc-ip 10.10.10.161
